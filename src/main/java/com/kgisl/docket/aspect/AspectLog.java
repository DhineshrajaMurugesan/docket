package com.kgisl.docket.aspect;
...
public class AspectLog implements ThrowsAdvice {
    ...
    @Pointcut("execution(* com.kgisl.docket.service.*.*(..))")
    public void controller() {
    }
    @Pointcut("execution(* com.kgisl.docket.service.*.*(..))")
    protected void allMethod() {
    }
    @Before("execution(* com.kgisl.docket.service.*.*(..))")
...
@AfterThrowing(pointcut="execution(* com.kgisl.docket.Controller.*.*(..))", 
        throwing="excep")
